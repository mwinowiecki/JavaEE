...
<%
	...
	out.println("<td><a href=\"updateFoodForm?foodId="+String.valueOf(food.getId())+"&name="+String.valueOf(food.getName())
				+"&typ="+String.valueOf(food.getTyp())+"&sklad="+String.valueOf(food.getSklad())
				+"&Cena="+Float.valueOf(food.getCena())+"\">Update</a></td></tr><br/>");
